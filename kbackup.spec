...
Version  : 22.12.0
Release  : 48
URL      : https://download.kde.org/stable/release-service/22.12.0/src/kbackup-22.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/kbackup-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/kbackup-22.12.0.tar.xz.sig
...
%prep
%setup -q -n kbackup-22.12.0
cd %{_builddir}/kbackup-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670534603
mkdir -p clr-build
pushd clr-build
