...
Version  : 23.08.1
Release  : 59
URL      : https://download.kde.org/stable/release-service/23.08.1/src/kbackup-23.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.1/src/kbackup-23.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.1/src/kbackup-23.08.1.tar.xz.sig
...
%prep
%setup -q -n kbackup-23.08.1
cd %{_builddir}/kbackup-23.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695084185
mkdir -p clr-build
pushd clr-build
