...
Source0  : https://download.kde.org/stable/release-service/20.12.1/src/kbackup-20.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.1/src/kbackup-20.12.1.tar.xz.sig
...
%prep
%setup -q -n kbackup-20.12.1
cd %{_builddir}/kbackup-20.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610047244
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kbackup-20.12.1/COPYING %{buildroot}/usr/share/package-licenses/kbackup/4778e718b2212917a612ca048ce876fb95dfa04e
pushd clr-build
%make_install
popd
%find_lang kbackup
