...
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/kbackup-21.12.0.tar.xz
...
%prep
%setup -q -n kbackup-21.12.0
cd %{_builddir}/kbackup-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639628801
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kbackup-21.12.0/COPYING %{buildroot}/usr/share/package-licenses/kbackup/4778e718b2212917a612ca048ce876fb95dfa04e
pushd clr-build
%make_install
popd
%find_lang kbackup
