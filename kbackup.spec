...
Source0  : https://download.kde.org/stable/release-service/23.08.0/src/kbackup-23.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.0/src/kbackup-23.08.0.tar.xz.sig
...
%prep
%setup -q -n kbackup-23.08.0
cd %{_builddir}/kbackup-23.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693021878
mkdir -p clr-build
pushd clr-build
