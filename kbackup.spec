...
Source0  : https://download.kde.org/stable/release-service/21.08.2/src/kbackup-21.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.2/src/kbackup-21.08.2.tar.xz.sig
...
%prep
%setup -q -n kbackup-21.08.2
cd %{_builddir}/kbackup-21.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634360631
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kbackup-21.08.2/COPYING %{buildroot}/usr/share/package-licenses/kbackup/4778e718b2212917a612ca048ce876fb95dfa04e
pushd clr-build
%make_install
popd
%find_lang kbackup
